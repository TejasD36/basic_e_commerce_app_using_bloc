...
import '../../features/products/presentation/view/products_view.dart';
...
class AppRouter {
  static GoRouter createRouter({required List<NavigatorObserver> observers}) {
    return GoRouter(
      ...
      observers: observers,
      routes: [
        GoRoute(path: AppRoute.splash.path, name: AppRoute.splash.name, builder: (context, state) => const SplashView()),
